...
post_id: 253
---
![The new Kiwibank homepage viewed on different devices](/assets/2012/05/kiwibank.jpg)
...
> One of the key changes has been to start the whole team (designers, developers, front-end devs) on the project at once. Even before the designs were finished, we needed a slick front-end framework, and the back end guys had to wrestle the <abbr>IIS</abbr>/<abbr>ASP</abbr> classic server into submission too. Having the whole team locked-down on the project made the decision making process much snappier and enabled us to solve problems without calling too many meetings. 
>
...
[2]: http://youtube.com/watch?v=UyaakUyciGg
