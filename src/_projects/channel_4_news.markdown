...
{% include image.html preset="supporting" src="projects/channel_4_news/category.png" alt="Category screen" %}
{% include image.html preset="supporting" src="projects/channel_4_news/special_report.png" alt="Special Report screen" %}
{% include image.html preset="supporting" src="projects/channel_4_news/catch_up.png" alt="Catch-up screen" %}
{% endfigure %}
