...
{% figure caption:"My original writing style (top) versus that recommended by Dave Gray (bottom)" class:"u-extend" %}
{% include image.html path="2010/05/learning_to_sketch.png" %}
{% endfigure %}
