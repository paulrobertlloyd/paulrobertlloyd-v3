...
{% figure caption:"US Marine Corps War Memorial and Netherlands Carillon" class:"u-abreast" %}
{% include image.html preset="supporting" path="2008/12/washington_dc_iwo_jima_memorial.jpg" alt="US Marine Corps War Memorial" %}
{% include image.html preset="supporting" path="2008/12/washington_dc_netherlands_carillon.jpg" alt="Netherlands Carillon" %}
{% endfigure %}
...
{% figure caption:"The Pentagon Memorial" class:"u-bleed" %}
{% include image.html preset="showcase" path="2008/12/washington_dc_pentagon_memorial.jpg" %}
{% endfigure %}
...
{% figure caption:"The main terminal building at Washington Dulles International Airport" class:"u-bleed" %}
{% include image.html preset="showcase" path="2008/12/washington_dc_dulles.jpg" %}
{% endfigure %}
