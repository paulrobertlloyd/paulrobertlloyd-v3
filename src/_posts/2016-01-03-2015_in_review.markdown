...
{% include image.html path="2016/01/2015_nieces.jpg" alt="Maria and Ana" %}
{% endfigure %}
...
{% include image.html preset="showcase" path="2016/01/2015_bruges.jpg" alt="Bruges" %}
<div class="u-abreast">
{% include image.html path="2016/01/2015_berlin.jpg" alt="Fernsehturm, Berlin" %}
{% include image.html path="2016/01/2015_amsterdam.jpg" alt="A’DAM, Amsterdam" %}
{% include image.html path="2016/01/2015_rotterdam.jpg" alt="Cube Houses, Rotterdam" %}
</div>
{% endfigure %}
...
{% include image.html preset="showcase" path="2016/01/2015_ubatuba.jpg" %}
{% endfigure %}
