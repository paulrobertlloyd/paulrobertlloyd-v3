...
{% include image.html src="2009/09/birmingham_city_council_versus_the_twitterati_website.png" %}
{% endfigure %}
...
{% include image.html src="2009/09/birmingham_city_council_versus_the_twitterati_tweet.png" %}
{% endfigure %}
