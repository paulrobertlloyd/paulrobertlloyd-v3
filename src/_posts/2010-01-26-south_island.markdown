...
{% include image.html preset="showcase" src="2010/01/south_island_queen_charlotte_sound.jpg" %}
{% endfigure %}
...
{% include image.html src="2010/01/south_island_christ_church_cathedral.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2010/01/south_island_tahunanui_beach.jpg" %}
{% endfigure %}
...
{% include image.html src="2010/01/south_island_kayaking.jpg" %}
{% endfigure %}
