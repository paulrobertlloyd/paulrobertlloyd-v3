...
{% include image.html src="2013/08/visual_design_explorations_mood_board.png" %}
{% endfigure %}
...
{% include image.html src="2013/08/visual_design_explorations_style_tiles.png" %}
{% endfigure %}
...
{% include image.html src="2013/08/visual_design_explorations_element_collage.png" %}
{% endfigure %}
