...
{% include image.html src="2009/01/2008_in_review_new_office.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2009/01/2008_in_review_nebraska.jpg" %}
{% endfigure %}
...
{% include image.html preset="supporting" src="2009/01/2008_in_review_seattle.jpg" %}
{% endfigure %}
