...
{% include image.html preset="showcase" src="2009/01/day_one_cannock_chase_2.jpg" alt="Frosty Cannock Chase" %}
{% endfigure %}

{% figure caption:"Frost over Cannock Chase" class:"u-bleed u-abreast" %}
{% include image.html src="2009/01/day_one_cannock_chase_3.jpg" alt="Frosty Cannock Chase" %}
{% include image.html src="2009/01/day_one_cannock_chase_4.jpg" alt="Frosty Cannock Chase" %}
{% endfigure %}
