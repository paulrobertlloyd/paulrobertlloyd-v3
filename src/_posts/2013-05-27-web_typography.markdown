...
{% include image.html path="2013/05/web_typography_bradshaws_cover.png" %}
{% endfigure %}
...
{% include image.html path="2013/05/web_typography_bradshaws_type.png" %}
{% endfigure %}
...
{% include image.html path="2013/05/web_typography_bradshaws_web.png" %}
{% endfigure %}
