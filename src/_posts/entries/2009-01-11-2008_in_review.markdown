...
{% figure caption:"My new desk and office space in February" class:"u-extend" %}
{% include image.html path="2009/01/2008_in_review_new_office.jpg" %}
{% endfigure %}
...
{% figure caption:"Waking up on the third day of my trip on the California Zephyr, I was greeted by this amazing sunrise over Nebraskan farmland" class:"u-bleed" %}
{% include image.html preset="showcase" path="2009/01/2008_in_review_nebraska.jpg" %}
{% endfigure %}
...
{% figure caption:"Seattle's Space Needle, taken from Queen Anne Hill" class:"u-pull-right" %}
{% include image.html preset="supporting" path="2009/01/2008_in_review_seattle.jpg" %}
{% endfigure %}
