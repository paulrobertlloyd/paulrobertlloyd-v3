...
{% figure caption:"Queen Charlotte Sound" class:"u-bleed" %}
{% include image.html preset="showcase" path="2010/01/south_island_queen_charlotte_sound.jpg" %}
{% endfigure %}
...
{% figure caption:"Christ Church Cathedral, Nelson" %}
{% include image.html path="2010/01/south_island_christ_church_cathedral.jpg" %}
{% endfigure %}
...
{% figure caption:"Sunset over Tahunanui Beach, with the Abel Tasman National Park in the distance" class:"u-bleed" %}
{% include image.html preset="showcase" path="2010/01/south_island_tahunanui_beach.jpg" %}
{% endfigure %}
...
{% figure caption:"Me looking rather fetching in my kayaking gear" %}
{% include image.html path="2010/01/south_island_kayaking.jpg" %}
{% endfigure %}
