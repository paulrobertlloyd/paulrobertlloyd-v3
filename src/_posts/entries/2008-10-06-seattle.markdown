...
{% figure caption:"Pike Place market" class:"u-extend" %}
{% include image.html path="2008/10/seattle_pike_place.jpg" %}
{% endfigure %}
...
{% figure caption:"Inside Seattle Central Library" class:"u-extend" %}
{% include image.html path="2008/10/seattle_central_library.jpg" %}
{% endfigure %}
