...
{% figure caption:"The breathtaking interior of Santuário Dom Bosco" class:"u-bleed" %}
{% include image.html preset="showcase" path="2011/07/remembering_brasilia_dom_bosco.jpg" %}
{% endfigure %}
