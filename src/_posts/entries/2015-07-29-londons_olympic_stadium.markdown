...
{% include image.html preset="showcase" path="2015/07/montreal_stade_olympique.jpg" %}
{% endfigure %}
...
{% include image.html preset="supporting" path="2015/07/london_olympic_stadium_exploded.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" path="2015/07/jessica_ennis_super_saturday_2012.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" path="2015/07/london_olympic_stadium_2015.jpg" %}
{% endfigure %}
...
{% include image.html path="2015/07/london_white_city_stadium_1908.jpg" alt="Postcard showing an illustration of London's White City Stadium in 1908" %}
{% endfigure %}
...
{% include image.html preset="showcase" path="2015/07/tokyo_olympic_stadium_proposal.jpg" %}
{% endfigure %}
