...
{% figure caption:"The [MV Blue Marlin](https://en.wikipedia.org/wiki/MV_Blue_Marlin), a ship that can ship shipping ships" class:"u-bleed" %}
{% include image.html path="2015/07/shipped.jpg" %}
{% endfigure %}
...
{% figure caption:"Design viewed on tablet and phone" class:"u-bleed" %}
