...
{% figure caption:"Walsall Council: The original logo and the revised version (2005)" %}
{% include image.html path="2009/02/simply_walsall_council_logos.png" %}
{% endfigure %}
...
{% figure caption:"Walsall College: The original logo and the revised version (2009)" %}
{% include image.html path="2009/02/simply_walsall_college_logos.png" %}
{% endfigure %}
