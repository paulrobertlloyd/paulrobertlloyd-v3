...
image:
  url: 2010/01/sydney_harbour.jpg
...
{% figure caption:"The crowds patiently wait to see the firework display from Mrs. Macquaries Point" %}
{% include image.html path="2010/01/sydney_nye.jpg" %}
{% endfigure %}
