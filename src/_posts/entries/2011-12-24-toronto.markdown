...
{% figure caption:"OCAD University building from McCaul Street" %}
{% include image.html path="2011/12/toronto_ocad.jpg" %}
{% endfigure %}
...
{% figure caption:"Staircase inside the Art Gallery of Ontario" %}
{% include image.html path="2011/12/toronto_ago.jpg" %}
{% endfigure %}
...
{% figure caption:"The Italian stained glass dome in Casa Loma's conservatory. Such was Pellatt's attention to detail, this was backlit so it could be illuminated during the evening too" %}
{% include image.html path="2011/12/toronto_casa_loma.jpg" %}
{% endfigure %}
