...
image:
  url: 2015/03/berlin_brandenburg_gate.jpg
...
{% figure caption:"A U-Bahn train arrives at Alexanderplatz station" %}
{% include image.html path="2015/03/berlin_ubahn.jpg" %}
{% endfigure %}
...
{% figure caption:"The imposing gates to Berlin's Olympic Stadium" class:"u-bleed" %}
{% include image.html preset="showcase" path="2015/03/berlin_olympiastadion.jpg" %}
{% endfigure %}
...
{% figure caption:"Much of the stadium appears as it did during the 1936 Olympic Games" %}
{% include image.html path="2015/03/berlin_olympiastadion_corridor.jpg" %}
{% endfigure %}
...
{% figure caption:"A short section of restored Berlin Wall, complete with watch tower" %}
{% include image.html path="2015/03/berlin_wall.jpg" %}
{% endfigure %}
