...
### Navigation
{% include image.html preset="thumbnail" path="2012/02/niptuck_navigation_icons.png" alt="Navigation icons" class="u-align-right" %}One of the biggest changes to the design is around the header. As [I wrote previously][9], the old design had a large footer that contained links to the *About* and *Archive* sections as well as a site search, social links and copyright information. This meant I could hide the two duplicated links in the header when they no longer fit.
