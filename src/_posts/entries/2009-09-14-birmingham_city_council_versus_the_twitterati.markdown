...
{% include image.html path="2009/09/birmingham_city_council_versus_the_twitterati_website.png" %}
{% endfigure %}
...
{% figure caption:"Walsall Council replying to a question from me on Twitter" %}
{% include image.html path="2009/09/birmingham_city_council_versus_the_twitterati_tweet.png" %}
{% endfigure %}
