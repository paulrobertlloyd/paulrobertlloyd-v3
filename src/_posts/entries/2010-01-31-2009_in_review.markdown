...
{% figure caption:"[That's Not My Name](/2009/02/thats_not_my_name), one of the many reasons I grew tired of travel within the United States" %}
{% include image.html path="2009/02/thats_not_my_name.jpg" alt="'Coll' written on the side of a Starbucks cup" %}
{% endfigure %}
...
{% figure caption:"Sir John Betjeman looks towards the Eurostar at St. Pancras Station" %}
{% include image.html path="2010/01/2009_in_review_st_pancras.jpg" %}
{% endfigure %}
...
{% figure caption:"Lee and Jon on the Precipice Walk" %}
{% include image.html path="2010/01/2009_in_review_lee_and_jon.jpg" alt="Lee Nash and Jon Roobottom" %}
{% endfigure %}
...
{% figure caption:"The 2009 Formula One World Championship, and in particular debut entrant Brawn GP, gained my full attention throughout the year" %}
{% include image.html path="2010/01/2009_in_review_brawn_gp.jpg" alt="Jenson Button driving the BGP 001 Formula One car" %}
{% endfigure %}
