...
{% picture /2009/02/thats_not_my_name.jpg alt="'Coll' written on the side of a Starbucks cup" %}
{% endfigure %}
...
{% picture /2010/01/2009_in_review_st_pancras.jpg alt="" %}
{% endfigure %}
...
{% picture /2010/01/2009_in_review_lee_and_jon.jpg alt="Lee Nash and Jon Roobottom" %}
{% endfigure %}
...
{% picture /2010/01/2009_in_review_brawn_gp.jpg alt="Jenson Button driving the BGP 001 Formula One car" %}
{% endfigure %}
