...
image:
  url: 2011/03/brasilia_palace_hotel.jpg
...
{% include image.html path="2011/03/brasilia_palace_hotel_chairs.jpg" %}
{% endfigure %}
...
{% include image.html path="2011/03/brasilia_palace_hotel_athos_bulcao_mural.jpg" %}
{% endfigure %}
...
{% include image.html path="2011/03/brasilia_palace_hotel_rural_willys.jpg" %}
{% endfigure %}
