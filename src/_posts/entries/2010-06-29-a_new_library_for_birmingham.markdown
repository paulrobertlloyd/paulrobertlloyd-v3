...
image:
  url: 2010/06/a_new_library_for_birmingham.jpg
...
{% figure caption:"Artists impression of the new Library of Birmingham in relation to Centenary Square" %}
{% include image.html path="2010/06/a_new_library_for_birmingham_2013.jpg" %}
{% endfigure %}
...
{% figure caption:"Birmingham Central Library, as it looks today. Photograph: [Tony Hiskett](https://www.flickr.com/photos/hisgett/4620759355/)" %}
{% include image.html path="2010/06/a_new_library_for_birmingham_2010.jpg" %}
{% endfigure %}
...
{% figure caption:"Inside Birmingham Central Library, as it was in 1974" class:"u-extend" %}
{% include image.html path="2010/06/a_new_library_for_birmingham_1974.jpg" %}
{% endfigure %}
