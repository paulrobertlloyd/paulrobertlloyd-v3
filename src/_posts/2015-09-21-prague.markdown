...
{% figure caption:"Construction workers laying a new pavement" class:"u-pull-right" %}
{% include image.html preset="supporting" path="2015/09/prague_pavement_construction.jpg" %}
{% endfigure %}
