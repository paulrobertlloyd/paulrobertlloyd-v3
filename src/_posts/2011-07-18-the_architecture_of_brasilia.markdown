...
{% include image.html preset="showcase" src="2011/07/the_architecture_of_brasilia_lines.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2011/07/the_architecture_of_brasilia_reflection.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2011/07/the_architecture_of_brasilia_suspension.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2011/07/the_architecture_of_brasilia_entry.jpg" %}
{% endfigure %}
