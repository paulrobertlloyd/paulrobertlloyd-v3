...
{% include image.html preset="supporting" src="2011/12/ottawa_confederation_hall.jpg" alt="Confederation Hall" %}
{% include image.html preset="supporting" src="2011/12/ottawa_senate.jpg" alt="Candanian Senate" %}
{% endfigure %}
...
{% include image.html src="2011/12/ottawa_cmc.jpg" %}
{% endfigure %}
...
{% include image.html src="2011/12/ottawa_occupy.jpg" alt="A protest sign in the Occupy Ottawa camp reads FOR SALE: HEALTH CARE" %}
{% endfigure %}
