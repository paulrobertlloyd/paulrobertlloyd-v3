...
{% figure caption:"Barack Obama <cite>Hope</cite> poster by Shepard Fairey" class:"u-pull-right" %}
{% include image.html preset="supporting" path="2009/01/obama_hope_poster.png" %}
{% endfigure %}

By the time of the [Iowa Caucuses][3], and [New Hampshire primaries][4] I had decided that I would be returning to the UK, yet I continued to watch the election with a keen interest, watching every debate, every concession speech, every victory rally.
