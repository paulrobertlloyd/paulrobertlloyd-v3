...
{% include image.html src="2010/09/bbc_news_redesign.jpg" %}
{% endfigure %}
...
{% include image.html src="2010/09/bbc_news_redesign_msnbc.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2010/09/bbc_news_redesign_variations.png" %}
{% endfigure %}
