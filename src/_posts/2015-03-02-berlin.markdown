...
{% include image.html src="2015/03/berlin_ubahn.jpg" %}
{% endfigure %}
...
{% include image.html preset="showcase" src="2015/03/berlin_olympiastadion.jpg" %}
{% endfigure %}
...
{% include image.html src="2015/03/berlin_olympiastadion_corridor.jpg" %}
{% endfigure %}
...
{% include image.html src="2015/03/berlin_wall.jpg" %}
{% endfigure %}
