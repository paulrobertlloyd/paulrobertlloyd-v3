...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-19a.png" alt="Still from Channel 4 'Richard Whitely' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-19b.png" alt="Still from Channel 4 'Richard Whitely' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-19c.png" alt="Still from Channel 4 'Richard Whitely' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-19d.png" alt="Still from Channel 4 'Richard Whitely' ident, 2002" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20a.png" alt="Still from Channel 4 'Red' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20b.png" alt="Still from Channel 4 'Red' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20c.png" alt="Still from Channel 4 'Red' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20d.png" alt="Still from Channel 4 'Red' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20e.png" alt="Still from Channel 4 'Purple' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20f.png" alt="Still from Channel 4 'Purple' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20g.png" alt="Still from Channel 4 'Purple' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20h.png" alt="Still from Channel 4 'Purple' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20i.png" alt="Still from Channel 4 'Green' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20j.png" alt="Still from Channel 4 'Green' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20k.png" alt="Still from Channel 4 'Green' ident, 2001" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-20l.png" alt="Still from Channel 4 'Green' ident, 2001" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-21a.png" alt="Still from Channel 4 'Lines' next-up caption, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-21b.png" alt="Still from Channel 4 'Lines' holding caption, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-21c.png" alt="Still from Channel 4 'Lines' information caption, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-21d.png" alt="Still from Channel 4 'Lines' promotion end caption, 2003" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-22a.png" alt="Still from Channel 4 'Ripples' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-22b.png" alt="Still from Channel 4 'Ripples' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-22c.png" alt="Still from Channel 4 'Ripples' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-22d.png" alt="Still from Channel 4 'Ripples' ident, 2002" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-23a.png" alt="Still from Channel 4 'Waveforms' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-23b.png" alt="Still from Channel 4 'Slots' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-23c.png" alt="Still from Channel 4 'Vapour Trails' ident, 2002" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-23d.png" alt="Still from Channel 4 'Film' ident, 2002" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-24a.png" alt="Still from BBC One 'English 11' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-24b.png" alt="Still from BBC One 'Scotish 6' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-24c.png" alt="Still from BBC One 'Carnival' ident, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-24d.png" alt="Still from BBC One 'Skateboarders' ident, 2000" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-25a.png" alt="Still from BBC Two 'Paint' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-25b.png" alt="Still from BBC Two 'Paint Pot' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-25c.png" alt="Still from BBC Two 'Arial' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-25d.png" alt="Still from BBC Two 'Kebab' ident, 2000" %}
{% endfigure %}

{% figure caption:"Figure 26: All of the BBC's children's output was given a new look, using just the colours yellow and black and a distinct use of simple animation" class:"u-abreast" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-26a.png" alt="Still from CBBC 'Mouse' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-26b.png" alt="Still from CBBC 'Mouse' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-26c.png" alt="Still from CBBC 'Mouse' ident, 1997" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-26d.png" alt="Still from CBBC 'Mouse' ident, 1997" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-27a.png" alt="Still from Anglia ITV hearts ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-27b.png" alt="Still from Anglia ITV hearts ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-27c.png" alt="Still from Anglia ITV hearts ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-27d.png" alt="Still from Anglia ITV hearts ident, 1999" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-28a.png" alt="Still from 'Search Lights' hearts sequence" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-28b.png" alt="Still from 'Funfair' hearts sequence" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-28c.png" alt="Still from 'Football Pitch' hearts sequence" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-28d.png" alt="Still from 'Beach' hearts sequence" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-29a.png" alt="Still from LWT 'Videowall' ident, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-29b.png" alt="Still from LWT 'Videowall' ident, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-29c.png" alt="Still from LWT 'Videowall' ident, 2000" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-29d.png" alt="Still from LWT 'Videowall' ident, 2000" %}
{% endfigure %}
...
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30a.png" alt="Still from Carlton ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30b.png" alt="Still from Carlton ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30c.png" alt="Still from Carlton ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30d.png" alt="Still from Carlton ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30e.png" alt="Still from Grampian Television ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30f.png" alt="Still from Grampian Television ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30g.png" alt="Still from Grampian Television ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30h.png" alt="Still from Grampian Television ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30i.png" alt="Still from UTV ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30j.png" alt="Still from UTV ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30k.png" alt="Still from UTV ident, 1999" %}
{% include image.html preset="thumbnail" src="articles/dissertation/figure-30l.png" alt="Still from UTV ident, 1999" %}
{% endfigure %}
