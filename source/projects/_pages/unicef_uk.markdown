...
{% picture supporting /projects/unicef_uk/homepage_prioritisation.jpg %}
{% picture supporting /projects/unicef_uk/pattern_identification.jpg %}
{% picture supporting /projects/unicef_uk/pattern_definition.jpg %}
{% endfigure %}
