...
{% figure caption:'Offline versus online brand guidelines' %}
{% endfigure %}

{% figure caption:'Colour palette, patterns, artists photo' %}
{% endfigure %}
...
{% figure caption:'Artist shown front and centre on a page layout' %}
{% endfigure %}
...
## Responsive design
{% figure caption:'Pattern portfolio' %}
{% endfigure %}
...
{% figure caption:'<cite>Tania Spriggens, Director of Communications</cite>' %}
