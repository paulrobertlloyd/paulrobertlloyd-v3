...
## Brand identity
{% figure caption:'Early identity sketches' %}
{% endfigure %}

{% figure caption:'nGenera logo with tagline lock-up' %}
{% endfigure %}
...
## Collateral
{% figure caption:'Associated brand collateral, including presentation folders, report covers, letterheads and business cards' %}
{% endfigure %}
...
## Website
{% figure caption:'Home page' %}
{% endfigure %}

{% figure caption:'Community landing page' %}
{% endfigure %}
