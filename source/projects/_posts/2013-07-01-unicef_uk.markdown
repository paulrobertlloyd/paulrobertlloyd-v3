...
{% figure caption:'Roboto type specimen' %}
{% endfigure %}

{% figure caption:'UNICEF colour palette' %}
{% endfigure %}
...
{% figure caption:'Whiteboard showing sketched patterns' %}
{% endfigure %}
...
## Navigation
{% figure caption:'Slide out menu on mobile' %}
{% endfigure %}

{% figure caption:'Section menu on desktop' %}
{% endfigure %}
...
## Mobile-first design
{% figure caption:'Design on mobile and tablet' %}
{% endfigure %}
