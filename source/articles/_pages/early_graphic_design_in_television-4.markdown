...
{% figure figure--image-quintet "Figure 9: Title sequence from <cite>Doctor Who</cite> (BBC 1963. Designed by Bernard Lodge). [Watch on YouTube](https://www.youtube.com/watch?v=Oz7e9kQ2-Uk)" %}
...
{% figure figure--image-quintet "Figure 10: Title sequence from <cite>Doctor Who</cite> (BBC 1973. Designed by Bernard Lodge). [Watch on YouTube](https://www.youtube.com/watch?v=bKg9tuSbXmk)" %}
...
{% figure l-align-left "Figure 11: Typical still used up until the late 1970's to illustrate current affairs or news items. If the item were to complicated to convey in a single still, it would be animated" %}
{% picture supporting /articles/early_graphic_design_in_television/figure-11.png %}
{% endfigure %}
...
{% figure figure--image-quintet "Figure 12: Title sequence from <cite>Weekend World</cite> (LWT 1982. Creative Director/Designer: Martin Lambie-Nairn) [Watch on YouTube](https://www.youtube.com/watch?v=Nsf6zIxlOd8)" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12a.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12b.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12c.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12d.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12e.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12f.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12g.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12h.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12i.png alt="Still from ident" %}
{% picture thumbnail /articles/early_graphic_design_in_television/figure-12j.png alt="Still from ident" %}
{% endfigure %}
...
{% figure figure--image-quintet "Figure 13: Channel Four ident <cite>Round and Back</cite> (Channel Four 1982. Creative Director/Designer: Martin Lambie-Nairn)" %}
