...
permalink: /articles/biege_to_bondiblue.html
---
...
{% figure l-pull-right "An Apple II Advertisement" %}
{% picture supporting /essays/beige_to_bondiblue/apple_ii_advert.jpg %}
{% endfigure %}
...
{% figure l-extend "The iMac" %}
{% picture showcase /essays/beige_to_bondiblue/apple_imac.jpg %}
{% endfigure %}
...
{% figure l-extend %}
{% picture showcase /essays/beige_to_bondiblue/apple_imac_flowershot.png alt="iMac Flowershot" %}
{% endfigure %}
