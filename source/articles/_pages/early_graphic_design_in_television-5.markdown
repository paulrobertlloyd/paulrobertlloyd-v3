...
{% figure u-align-left "Figure 14: A film rostrum camera. Computer controlled rostrum cameras were introduced around the late 1970's" %}
{% picture supporting /articles/early_graphic_design_in_television/figure-14.jpg alt="" %}
{% endfigure %}
...
{% figure c-figure--image-quintet "Figure 15: Yorkshire Television ident <cite>Liquid Gold</cite> (Yorkshire Television 1986. Designed by Jeff Parr)" %}
...
{% figure c-figure--image-quintet "Figure 16: Title sequence from <cite>Ghosts in the Machine II</cite> (Channel Four 1988. Designed by Richard Markell)" %}
