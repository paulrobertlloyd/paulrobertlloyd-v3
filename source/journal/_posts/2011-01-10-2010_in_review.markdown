...
{% figure u-bleed "Reflection of Melbourne's CBD in a window at Albert Park" %}
...
## June
{% figure u-bleed "My favourite photo taken during Lomo Workshop" %}
...
{% figure u-bleed "Quiraing, Isle of Skye" %}
...
{% figure u-bleed "Belfast City Hall" %}
