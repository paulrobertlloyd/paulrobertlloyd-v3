...
{% figure "A U-Bahn train arrives at Alexanderplatz station" %}
...
{% figure u-bleed "The imposing gates to Berlin's Olympic Stadium" %}
...
{% figure "Much of the stadium appears as it did during the 1936 Olympic Games" %}
...
{% figure "A short section of restored Berlin Wall, complete with watch tower" %}
