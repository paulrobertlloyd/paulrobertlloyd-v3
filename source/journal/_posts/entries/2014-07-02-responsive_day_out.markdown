...
{% image bleed %}
![](/source/assets/images/2014/07/responsive_day_out.jpg "Jeremy Keith interviewing Ethan Marcotte. Photo by Marc Thiele")
{% endimage %}

_TODO: Responsive images with linked captions_
