...
{% figure caption:'Cannock Chase German Military Cemetery' %}
...
{% figure caption:'Another scene from Cannock Chase' %}
![](/assets/images/2009/01/day_one_cannock_chase_2.jpg)
{% endfigure %}

{% figure class:'figure--2up', caption:'More scenes from Cannock Chase' %}
