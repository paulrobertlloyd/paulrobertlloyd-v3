...
tags:
  ...
  - United States
---
{% figure class:'class1 class2', caption:"_Cloud Gate_ by Anish Kapoor" %}
![](/assets/images/2008/12/chicago.jpg)
{% endfigure %}
...
{% figure class:'l-hang-left', caption:'Sears Tower as viewed during an architecture boat tour' %}
![](/assets/images/2008/12/chicago_sears_tower.jpg)
{% endfigure %}
