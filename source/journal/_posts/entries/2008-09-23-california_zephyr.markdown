...
discussion: closed
---
{% figure class:'l-bleed', caption:'The landscape you travel across is one of the most scenic routes run by Amtrak' %}
...
{% figure class:'l-bleed', caption:'Route of the California Zephyr' %}
