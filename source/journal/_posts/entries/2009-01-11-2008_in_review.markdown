...
{% figure caption:'My new desk and office space in February' %}
![](/assets/images/2009/01/2008_in_review_new_office.jpg)
{% endfigure %}
...
{% figure caption:'Waking up on the third day of my trip on the California Zephyr, I was greeted by this amazing sunrise over Nebraskan farmland' %}
![](/assets/images/2009/01/2008_in_review_nebraska.jpg)
{% endfigure %}
...
{% figure class:'l-hang-left', caption:'Seattle's Space Needle, taken from Queen Anne Hill' %}
![](/assets/images/2009/01/2008_in_review_seattle.jpg)
{% endfigure %}
