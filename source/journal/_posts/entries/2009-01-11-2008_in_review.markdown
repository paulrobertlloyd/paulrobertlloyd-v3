...
{% figure figure--caption-right l-extend "My new desk and office space in February" %}
{% picture /2009/01/2008_in_review_new_office.jpg %}
{% endfigure %}
...
{% figure l-extend "Waking up on the third day of my trip on the California Zephyr, I was greeted by this amazing sunrise over Nebraskan farmland" %}
{% picture showcase /2009/01/2008_in_review_nebraska.jpg %}
{% endfigure %}
...
{% figure l-pull-right "Seattle's Space Needle, taken from Queen Anne Hill" %}
{% picture supporting /2009/01/2008_in_review_seattle.jpg %}
{% endfigure %}
