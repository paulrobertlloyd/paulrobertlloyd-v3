...
{% figure figure--image-duo "There was plenty to admire inside the Canadian Parliament buildings" %}
{% picture supporting /2011/12/ottawa_confederation_hall.jpg %}
{% picture supporting /2011/12/ottawa_senate.jpg %}
{% endfigure %}
...
{% picture /2011/12/ottawa_cmc.jpg %}
{% endfigure %}
