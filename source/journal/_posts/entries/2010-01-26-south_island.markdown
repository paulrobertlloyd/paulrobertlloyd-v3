...
{% figure class:'l-bleed', caption:'The Overlander during its lunchtime stop at National Park railway station' %}
...
{% figure class:'l-bleed', caption:'Queen Charlotte Sound' %}
...
![](/assets/images/2010/01/south_island_christ_church_cathedral.jpg)
{% endfigure %}
...
{% figure caption:'Sunset over Tahunanui Beach, with the Abel Tasman National Park in the distance' %}
![](/assets/images/2010/01/south_island_tahunanui_beach.jpg)
{% endfigure %}
...
![](/assets/images/2010/01/south_island_kayaking.jpg)
{% endfigure %}
