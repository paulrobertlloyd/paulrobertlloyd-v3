...
{% image showcase /2009/05/le_corbusier.jpg %}
{% endfigure %}
...
{% figure class:'l-pull-left', caption:'The Philips Pavilion at the 1958 World's Fair in Brussels' %}
{% image /2009/05/le_corbusier_phillips_pavilion.jpg %}
{% endfigure %}
