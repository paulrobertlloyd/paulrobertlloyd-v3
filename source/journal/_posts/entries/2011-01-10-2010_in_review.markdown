...
{% figure l-extend "Reflection of Melbourne's CBD in a window at Albert Park" %}
...
## April
{% figure l-pull-right "Gene Hunt and Jim Keats from the final series of Ashes to Ashes" %}
...
## June
{% figure l-extend "My favourite photo taken during Lomo Workshop" %}
...
{% figure l-extend "Quiraing, Isle of Skye" %}
...
{% figure l-extend "Belfast City Hall" %}
