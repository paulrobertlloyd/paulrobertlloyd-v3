...
{% picture /2010/09/bbc_news_redesign.jpg %}
{% endfigure %}
...
{% picture /2010/09/bbc_news_redesign_msnbc.jpg %}
{% endfigure %}
...
{% figure l-extend "Different layout variations available to editors on the new BBC News website" %}
