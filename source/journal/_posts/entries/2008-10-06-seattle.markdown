...
{% figure l-bleed "The Space Needle with the Experience Music Project in the foreground" %}
...
{% figure figure--caption-right "Pike Place market" %}
...
{% figure figure--caption-right "Inside Seattle Central Library" %}
