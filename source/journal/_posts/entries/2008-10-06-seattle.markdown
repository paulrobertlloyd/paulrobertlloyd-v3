...
{% figure class:'l-bleed', caption:'The Space Needle with the Experience Music Project in the foreground' %}
![](/assets/images/2008/10/seattle_center.jpg)
{% endfigure %}
...
{% figure class:'l-pull-left', caption:'Pike Place market' %}
![](/assets/images/2008/10/seattle_pike_place.jpg)
{% endfigure %}
...
{% figure class:'l-pull-left', caption:'Inside Seattle Central Library' %}
![](/assets/images/2008/10/seattle_central_library.jpg)
{% endfigure %}
