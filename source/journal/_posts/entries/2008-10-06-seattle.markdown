...
{% figure 1up l-bleed "The Space Needle with the Experience Music Project in the foreground" %}
...
{% figure 1up l-pull-left "Pike Place market" %}
...
{% figure 1up l-pull-left "Inside Seattle Central Library" %}
