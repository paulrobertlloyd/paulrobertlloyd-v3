...
{% figure c-figure--caption-right u-extend "Artist photography shown front and centre on a page describing DACS' Payback service" %}
...
{% figure u-pull-right "<cite>Tania Spriggens, Director of Communications</cite>" %}
