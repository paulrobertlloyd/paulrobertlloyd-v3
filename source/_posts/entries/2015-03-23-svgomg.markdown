...
{% figure c-figure--caption-right "SVGOMG is easy to use and surfaces the range of optimisation options offered by SVGO" %}
{% picture /2015/03/svgomg.png alt="" %}
{% endfigure %}

* * *

<span class="u-caps">Paul Lloyd</span>: _SVGOMG has a truly native app feel. What obstacles did you overcome (if any) to make it work seamlessly on the web?_

<span class="u-caps">Jake Archibald</span>: It was easier than I expected, but I think I was expecting it to be impossible. I was surprised at how much I used [flexbox][6], and how stable it is across modern browsers. Pretty much all of the layout is flexbox driven.
...
PL: _One of the most pleasing features of the app is how it adapts to different screen sizes. Did you make any adaptions to your initial design/concept to achieve this?_
...
PL: _What progressive enhancement techniques and approaches did you use to ensure the widest possible usage for the app?_
...
PL: _You are a big proponent of web performance. What steps did you take to make the app feel speedy?_
