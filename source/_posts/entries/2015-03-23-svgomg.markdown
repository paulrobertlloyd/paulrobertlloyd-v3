...
### SVGOMG has a truly native app feel. What obstacles did you overcome (if any) to make it work seamlessly on the web?
...
> In terms of features, there are a couple of polyfills that are brought in dynamically for the browsers that need them. IE needs a [Promise polyfill][12], Safari needs Fastclick.
>
...
### You are a big proponent of web performance. What steps did you take to make the app feel speedy?
