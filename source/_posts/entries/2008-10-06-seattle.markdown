...
{% figure c-figure--caption-right u-bleed "Pike Place market" %}
{% picture /2008/10/seattle_pike_place.jpg alt="" %}
{% endfigure %}
...
{% figure c-figure--caption-right u-bleed "Inside Seattle Central Library" %}
{% picture /2008/10/seattle_central_library.jpg alt="" %}
{% endfigure %}
