...
{% picture /2012/02/gowalla_stamps.png alt="" %}
{% endfigure %}
...
{% figure c-figure--caption-right u-bleed "The Gowalla home page in January 2012. The growing prominence of Facebook account linking and sharing buttons on Gowalla hinted at its eventual fate" %}
{% picture /2012/02/gowalla_homepage.png alt="" %}
{% endfigure %}
